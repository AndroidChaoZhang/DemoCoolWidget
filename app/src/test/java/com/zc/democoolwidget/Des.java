...
public class Des {
    ...
    public static String abc(String args) {
        ...
        String key3 = "A5";
//        String data = "admin";
        String str = desObj.strEnc(args, key1, key2, key3);
//        System.out.println(str);
//        String dec = desObj.strDec(args, key1, key2, key3);
//        System.out.println(dec);
        return str;
    }

    public static String dentifyKey(String args,String key1,String key2,String key3) {
        Des desObj = new Des();
        String str = desObj.strEnc(args, key1, key2, key3);
        return str;
    }
