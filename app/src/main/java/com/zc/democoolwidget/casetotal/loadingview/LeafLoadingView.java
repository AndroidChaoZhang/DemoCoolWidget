...
import com.zc.democoolwidget.recycleview.excelcalendar.DpPxSpUtil;

import java.util.LinkedList;
import java.util.List;
import java.util.Random;

public class LeafLoadingView extends SurfaceView implements SurfaceHolder.Callback,Runnable {
    ...
    public LeafLoadingView(Context context, AttributeSet attrs) {
        ...
        mLeftMargin = DpPxSpUtil.dip2px(context, LEFT_MARGIN);
        mRightMargin = DpPxSpUtil.dip2px(context, RIGHT_MARGIN);
    ...
    public void onDrawView() {
        ...
        try {
            ...
            if (canvas != null)
                getHolder().unlockCanvasAndPost(canvas);//保证每次都将绘图的内容提交
        }
    }
    ...
    private void initBitmap() {
        ...
        mOuterBitmap = ((BitmapDrawable) mResources.getDrawable(R.drawable.icon_leaf_kuang)).getBitmap();
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        Log.e("MyLog","mArcRadius="+mArcRadius +"mTotalHeight="+mTotalHeight);
