...
//        v.reuse();
    ...
    @Override
    public void onDayClick(SimpleMonthView simpleMonthView, CalendarDay calendarDay,boolean isStartAndEndDateFlag) {
        if (calendarDay != null) {
            onDayTapped(calendarDay,isStartAndEndDateFlag);
        }
    }
     ...
     * 点时间
     *
     * @param isStartAndEndDateFlag 是否点击两次  一次出发时间  一次到达时间
     */
    protected void onDayTapped(CalendarDay calendarDay,boolean isStartAndEndDateFlag) {
        if(mController != null) {
            mController.onDayOfMonthSelected(calendarDay);
        }
        setRangeSelectedDay(calendarDay,isStartAndEndDateFlag);
    }
     ...
     * @param isStartAndEndDateFlag 是否点击两次  一次出发时间  一次到达时间
     */
    public void setRangeSelectedDay(CalendarDay calendarDay,boolean isStartAndEndDateFlag) {
        // 选择退房日期
        if (rangeDays.getFirst() != null && rangeDays.getLast() == null && isStartAndEndDateFlag) {
        ...
        } else if (rangeDays.getLast() != null && isStartAndEndDateFlag) {   // 重新选择入住日期
