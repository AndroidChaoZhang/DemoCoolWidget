...
JNIEXPORT void JNICALL Java_com_zc_democoolwidget_imagegaosi_stackblur_NativeBlurProcess_functionToBlur(JNIEnv* env, jclass clzz, jobject bitmapOut, jint radius, jint threadCount, jint threadIndex, jint round) {
    // Properties
